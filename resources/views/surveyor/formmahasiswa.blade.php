      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card">
            ...
            <div class="card-body">
              <form class="form-horizontal" action="{{route('store-mahasiswa-surveyor')}}"  method="post">
                {{csrf_field()}}
                <div class="form-group">
                  <label class="form-control-label">Nama Mahasiswa</label>
                    <input type="text" class="form-control" name="nama" value="{{ old('nama') }}" placeholder="Nama Mahasiswa" required>
                ...
                <div class="form-group">
                  <label class=" form-control-label">NIM Mahasiswa</label>
                    <input type="number" class="form-control" name="nim" value="{{ old('nim') }}" placeholder="NIM Mahasiswa"  required>
